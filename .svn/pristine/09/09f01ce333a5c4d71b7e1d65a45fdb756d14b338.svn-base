...
<tr class="line_emp">
    ...
    <td>
        <?php echo $form->textField($model,"[$id]company",array('class'=>'span')); ?>
    </td>
    <td >
        <?php echo $form->dropDownList($model,"[$id]job_id",CHtml::listData(Job::model()->findAll(),'id','name'),array('prompt'=>'Chọn...','class'=>'span')); ?>
    </td>
    <td>
    ...
    <td>
        <?php echo $form->textField($model,"[$id]description",array('class'=>'span')); ?>
    </td>
    <td>
