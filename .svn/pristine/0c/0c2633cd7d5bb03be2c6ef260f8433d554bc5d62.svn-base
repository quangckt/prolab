...
//     public $layout = 'sys.views.layouts.main';
    ...
    public $admin = array("/user/admin");
    public $returnUrlForEmployee = array("/hr/default/index");
    ...
    public function init()
    {
        ...
        $this->menuFunc = Yii::app()->getModule('sys')->menuFunc;
    }
