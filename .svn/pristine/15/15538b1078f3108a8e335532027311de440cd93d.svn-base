...
class RAuthItemBehavior extends CBehavior {
    ...
    public function childCount() {
        ...
        return $this->childCount > 0 ? ' <span class="badge badge-info pull-right">' . $this->childCount . '</span> ' : '';
    }
    ...
    public function getDeleteOperationLink() {
        return CHtml::linkButton(Rights::t('core', 'Xóa'), array(
    ...
    public function getRemoveParentLink() {
        return CHtml::linkButton(Rights::t('core', 'Loại bỏ'), array(
    ...
    public function getRevokeAssignmentLink() {
        return CHtml::linkButton(Rights::t('core', 'Thu hồi'), array(
    ...
    public function getRevokePermissionLink(CAuthItem $role) {
        ...
        return CHtml::link(Rights::t('core', 'Thu hồi'), '#', array(
                    'onclick' => "
				jQuery.ajax({
					type:'POST',
    ...
    public function getAssignPermissionLink(CAuthItem $role) {
        ...
        return CHtml::link(Rights::t('core', 'Gán'), '#', array(
                    'onclick' => "
				jQuery.ajax({
					type:'POST',
