...
class WarehouseController extends BaseController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['warehouse']))
		{
                 ...
                 //$session['warehouse_records']=Test::model()->findAll($criteria); 
                 $session['warehouse_dataProvider']=$model->search();
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['warehouse_records']))
               {
                $model=$session['warehouse_records'];
               }
               else
                 $model = warehouse::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['warehouse_dataProvider']))
                 {
                  $dataProvider=$session['warehouse_dataProvider'];
                 }
                else
		...
		$pdf->SetSubject('warehouse Report');
		...
		$pdf->LastPage();
		$pdf->Output("warehouse_002.pdf", "I");
	}
}
