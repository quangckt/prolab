<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-warehouseout-type-form',
	...
	<?php echo $form->textFieldRow($model,'wh_req',array('class'=>'span5','maxlength'=>255)); ?>
...
<?php $this->endWidget(); ?>
   ...
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-warehouseout-type-form").each(function() {
		var type = this.type;
