		<script type="text/javascript">
			...
			// Available commands: Print, Exit
			function sendCommand(command) {
				var flashMovie = document.getElementById("ViewerFx_PHP");
			...
			var attributes = {};
			attributes.id = "ViewerFx_PHP";
			attributes.name = "ViewerFx_PHP";
			attributes.align = "middle";
			swfobject.embedSWF(
				"<?php echo $this->module->getAssetsUrl()?>/swf/ViewerFx_PHP.swf", "flashContent", "100%", "100%", 
		...
		<noscript>
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="ViewerFx_PHP">
				<param name="movie" value="<?php echo $this->module->getAssetsUrl()?>/swf/ViewerFx_PHP.swf" />
				<param name="quality" value="high" />
				<param name="bgcolor" value="#e8e8e8" />
				<param name="allowScriptAccess" value="sameDomain" />
				<param name="allowFullScreen" value="true" />
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="<?php echo $this->module->getAssetsUrl()?>/swf/ViewerFx_PHP.swf" width="100%" height="100%">
					<param name="quality" value="high" />
					<param name="bgcolor" value="#e8e8e8" />
					<param name="allowScriptAccess" value="sameDomain" />
					<param name="allowFullScreen" value="true" />
