...
$menu2 = array(
    array('label' => 'Công việc', 'icon' => 'plus'),
    array('label' => 'Công việc', 'icon' => 'list-alt', 'url' => array('/rec/worklist/index')),
    array('label' => 'Thêm công việc', 'icon' => 'list-alt', 'url' => array('/rec/worklist/create')),
    array('label' => 'Khôi phục', 'icon' => 'list-alt', 'url' => array('/rec/worklist/recyclebin')),
    array('label' => 'Cài đặt', 'icon' => 'plus'),
    array('label' => 'Nhóm doanh thu', 'icon' => 'list-alt', 'url' => array('/rec/grouprevenue/index')),
    array('label' => 'Tổng hợp doanh số', 'icon' => 'list-alt', 'url' => array('/rec/aggregatesales/index')),
    array('label' => 'Chi tiết doanh số', 'icon' => 'list-alt', 'url' => array('/rec/detailssales/index')),
    array('label' => 'Vật tư sản xuất', 'icon' => 'list-alt', 'url' => array('/rec/materialproduction/index')),
    array('label' => 'Quy trình công việc', 'icon' => 'list-alt', 'url' => array('/rec/processes/index')),
);
$menu3 = array(
