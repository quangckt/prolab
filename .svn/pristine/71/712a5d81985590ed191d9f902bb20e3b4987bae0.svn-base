...
<div class="tools-bar">
    ...
    $this->widget('bootstrap.widgets.TbMenu', array(
        'type' => 'pills',
        'items' => array(
            array('label' => 'Các đợt chia lãi', 'icon' => 'icon-arrow-left', 'url' => Yii::app()->controller->createUrl('allProfit')),
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => 'Lũy kế',
            'type' => 'number',
            'value' => array($this, 'sumValueOfProfit'),
        ),
    ),
));?>
