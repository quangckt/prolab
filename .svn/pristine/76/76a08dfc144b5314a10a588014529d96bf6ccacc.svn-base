...
class CompanyController extends BaseController
{
	...
	public function accessRules()
	{
      ...
      public function actionGetItems(){
		$sql = 'SELECT id, name as value FROM rec_companyofcustomer WHERE name LIKE :qterm ORDER BY name ASC';
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Company']))
		{
                       ...
                       if (!empty($model->taxcode)) $criteria->addCondition('taxcode = "'.$model->taxcode.'"');
                 ...
                 //$session['Company_records']=Test::model()->findAll($criteria); 
                 $session['Company_dataProvider']=$model->search();
        ...
        public function actionGeneratePdf() 
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['Company_dataProvider']))
                 {
                  $dataProvider=$session['Company_dataProvider'];
                 }
                else
