...
class BranchController extends BaseController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Branch']))
		{
               ...
               //  $session['Branch_records']=Test::model()->findAll($criteria); 
                // $session['Branch_dataProvider']=$model->search();
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Branch_records']))
               {
                $model=$session['Branch_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['Branch_dataProvider']))
                 {
                  $dataProvider=$session['Branch_dataProvider'];
                 }
                else
