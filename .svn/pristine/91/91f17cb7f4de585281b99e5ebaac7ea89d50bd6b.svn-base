...
class Rights {
    ...
    public static function getAuthItemOptions() {
        return array(
            CAuthItem::TYPE_OPERATION => Rights::t('core', 'Hành động'),
            CAuthItem::TYPE_TASK => Rights::t('core', 'Nhiệm vụ'),
...
//			CAuthItem::TYPE_ROLE=>Rights::t('core', 'Role'),
    ...
    public static function getAuthItemTypeNamePlural($type) {
        switch ((int) $type) {
            ...
            case CAuthItem::TYPE_OPERATION: return Rights::t('core', 'Hành động');
            //case CAuthItem::TYPE_TASK: return Rights::t('core', 'Tasks');
            case CAuthItem::TYPE_TASK: return Rights::t('core', 'Nhiệm vụ');
