<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'valueofstock',array('class'=>'span5','maxlength'=>10)); ?>

	<?php echo $form->textFieldRow($model,'totalassets',array('class'=>'span5','maxlength'=>10)); ?>
...
<?php $this->endWidget(); ?>
   ...
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-share-form").each(function() {
		var type = this.type;
