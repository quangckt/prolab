...
class PaymentController extends BaseController
{
	...
	public function accessRules()
	{
      ...
      public function actionGetItems(){
		$sql = 'SELECT id, name as value FROM hr_payment WHERE name LIKE :qterm ORDER BY name ASC';
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Payment']))
		{
                       ...
                       if (!empty($model->tran_id)) $criteria->addCondition('tran_id = "'.$model->tran_id.'"');
                     
                    	
                       if (!empty($model->period_id)) $criteria->addCondition('period_id = "'.$model->period_id.'"');
                     
                    			
		}
                 //$session['Payment_records']=Test::model()->findAll($criteria); 
                 $session['Payment_dataProvider']=$model->search();
        ...
        public function actionGeneratePdf() 
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['Payment_dataProvider']))
                 {
                  $dataProvider=$session['Payment_dataProvider'];
                 }
                else
