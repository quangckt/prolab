...
class ProfitController extends BaseController
{
	...
	public function accessRules()
	{
      ...
      public function actionGetItems(){
		$sql = 'SELECT id, name as value FROM hr_profit WHERE name LIKE :qterm ORDER BY name ASC';
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Profit']))
		{
                       ...
                       if (!empty($model->amtdebit)) $criteria->addCondition('amtdebit = "'.$model->amtdebit.'"');
                 ...
                 //$session['Profit_records']=Test::model()->findAll($criteria);
                 $session['Profit_dataProvider']=$model->search();
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();
             ...
             if(isset($session['Profit_records']))
               {
                $model=$session['Profit_records'];
               }
               else
                 $model = Profit::model()->findAll();
        ...
        public function actionGeneratePdf()
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['Profit_dataProvider']))
                 {
                  $dataProvider=$session['Profit_dataProvider'];
                 }
                else
