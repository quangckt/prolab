...
class Formatter extends CFormatter
{
    ...
    */
    ...
    public function formatNumberOne($value) {
        if($value === null) return null;    // new
        if($value === '') return '';        // new
        return number_format($value, 1, $this->numberFormat['decimalSeparator'], $this->numberFormat['thousandSeparator']);
      }

    public function formatNumberTwo($value) {
        if($value === null) return null;    // new
        if($value === '') return '';        // new
