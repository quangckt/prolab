...
class DistrictController extends BaseController
{
	...
	public function accessRules()
	{
      ...
      public function actionGetItems(){
		$sql = 'SELECT id, name as value FROM hr_district WHERE name LIKE :qterm ORDER BY name ASC';
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['District']))
		{
                 ...
                 //$session['District_records']=Test::model()->findAll($criteria); 
                 $session['District_dataProvider']=$model->search();
        ...
        public function actionGeneratePdf() 
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['District_dataProvider']))
                 {
                  $dataProvider=$session['District_dataProvider'];
                 }
                else
