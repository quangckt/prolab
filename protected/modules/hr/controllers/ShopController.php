...
class ShopController extends BaseController
{
	...
	public function accessRules()
	{
      ...
      public function actionGetItems(){
		$sql = 'SELECT id, name as value FROM hr_shop WHERE name LIKE :qterm ORDER BY name ASC';
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Shop']))
		{
                 ...
                 //$session['Shop_records']=Test::model()->findAll($criteria); 
                 $session['Shop_dataProvider']=$model->search();
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Shop_records']))
               {
                $model=$session['Shop_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		require_once('tcpdf/config/lang/eng.php');
                ...
                if(isset($session['Shop_dataProvider']))
                 {
                  $dataProvider=$session['Shop_dataProvider'];
                 }
                else
		...
		$pdf->SetTitle('Shop Report');
		$pdf->SetSubject('Shop Report');
