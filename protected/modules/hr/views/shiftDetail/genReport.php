...
<div id="reportDetail">
    ...
    $this->widget('bootstrap.widgets.TbTabs', array(
        ...
        'tabs' => array(
            array(
                'label' => 'Tổng hợp thời gian làm việc',
                'content' => $this->renderPartial('_sumTimeWork', array(
                    'model' => $model,
                    'dep_id' => $dep_id,
                    'plan_id' => $plan_id,
                        ), true),
            ...
            array(
                ...
                'content' => $this->renderPartial('_sumBonusPT', array(
                    'model' => $model,
                    'dep_id' => $dep_id,
                    'plan_id' => $plan_id,
                        ), true),
            ...
            array(
                ...
                'content' => $this->renderPartial('_sumBonusValue', array(
                    'model' => $model,
                    'dep_id' => $dep_id,
                    'plan_id' => $plan_id,
                        ), true),
            ...
            array(
                ...
                'content' => $this->renderPartial('_sumSalary', array(
                    'model' => $model,
                    'dep_id' => $dep_id,
                    'plan_id' => $plan_id,
                        ), true),
