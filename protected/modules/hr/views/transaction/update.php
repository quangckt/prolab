...
<?php echo $this->renderPartial('_form', array('model' => $model, 'modelShare' => $modelShare, 'modelCash' => $modelCash, 'recordBatch' => $recordBatch, 'amtOfStockToSell' => $amtOfStockToSell, 'qtyOfStockToSell' => $qtyOfStockToSell)); ?>