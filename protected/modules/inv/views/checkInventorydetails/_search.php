<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-check-inventorydetails-form',
	...
	<?php echo $form->textFieldRow($model,'check_inventory_id',array('class'=>'span5')); ?>
...
<?php $this->endWidget(); ?>
   ...
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-check-inventorydetails-form").each(function() {
		var type = this.type;
