...
//                                        console.log(dataSplit['1']);
    ...
    <div class="row-fluid" style="margin-top: 0px;">
        <div class="well well-small" style="margin-top: 0px;">
            <div class="row-fluid">
                <?php echo CHtml::beginForm('', '', array('id' => 'abcdef')); ?>
                <div class="span12">
                    fjasyhfjahjfkh
                </div>
...
<div id="popover_content_wrapper_area" style="display: none">
    <?php echo CHtml::beginForm('', '', array('id' => 'popOverArea')); ?>
    <div class="row-fluid">
...
<div id="popover_content_wrapper_delivergroup" style="display: none">
    <?php echo CHtml::beginForm('', '', array('id' => 'popOverDelivergroup')); ?>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        ...
        echo CHtml::ajaxSubmitButton('Tạo', Yii::app()->controller->createUrl('createArea', array('action' => 'delivergroup')), array(
            //'dataType' => 'json',
            'data' => 'js:$("#popOverDelivergroup").serialize()',
            'complete' => 'function(data){
                var error = data.responseText.substring(0,5);
                var idNew = data.responseText.split("|");
                if(error=="error"){
...
<div id="popover_content_wrapper_produce" style="display: none">
    <?php echo CHtml::beginForm('', '', array('id' => 'popOverProduce')); ?>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        ...
        echo CHtml::ajaxSubmitButton('Tạo', Yii::app()->controller->createUrl('createArea', array('action' => 'produce')), array(
            //'dataType' => 'json',
            'data' => 'js:$("#popOverProduce").serialize()',
            'complete' => 'function(data){
                var error = data.responseText.substring(0,5);
                var idNew = data.responseText.split("|");
                if(error=="error"){
